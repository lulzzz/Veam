...
namespace Veam.Infra.Data.Migrations
{
    ...
    [Migration("20200224201752_checkgg")]
    partial class checkgg
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Veam.EAM.Domain.CheckOut", b =>
                {
                    ...
                    b.HasDiscriminator<string>("to").HasValue("CheckOut_base");
                });
            ...
            modelBuilder.Entity("Veam.EAM.Domain.CheckOutToEmployee", b =>
                {
                    b.HasBaseType("Veam.EAM.Domain.CheckOut");
                    ...
                    b.HasDiscriminator().HasValue("CheckOut_parent");
                });

            modelBuilder.Entity("Veam.EAM.Domain.CheckOutToLocation", b =>
                {
                    b.HasBaseType("Veam.EAM.Domain.CheckOut");
                    ...
                    b.Property<long>("managerId")
                        .HasColumnName("CheckOutToLocation_managerId")
                        .HasColumnType("bigint");

                    b.Property<long>("subsideryId")
                        .HasColumnName("CheckOutToLocation_subsideryId")
                        .HasColumnType("bigint");

                    b.HasDiscriminator().HasValue("CheckOut_Loc");
                });
                    ...
                    b.OwnsOne("Veam.EAM.Domain.RequestInfo", "requestInfo", b1 =>
                        {
                            ...
                            b1.Property<DateTime>("checkedOutDate")
                                .HasColumnType("datetime2");
